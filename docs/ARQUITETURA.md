...
| PUT | `/admin/equipamentos/{id}/documentos` | `gerir_usuarios` | Fixa **documentos** (manuais/datasheets da biblioteca) no equipamento (#EQP-DOC). |
| GET | `/equipamentos/{id}/documentos` | autenticado | Documentos fixados do equipamento (#EQP-DOC); RBAC pelo cliente. |
